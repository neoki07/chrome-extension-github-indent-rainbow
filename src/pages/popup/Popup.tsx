          ...
          <Form>
            ...
            <div style={{ marginBottom: '32px' }}>
              ...
              <div style={{ marginBottom: '8px' }}>
                ...
                example if you have your tabs set to 2 spaces but the indent is
                3 spaces. Can be any type of web based color format (hex, rgba,
                rgb).
              </div>
              <div
                className="col"
            ...
            <div style={{ marginBottom: '32px' }}>
              ...
              <div style={{ marginBottom: '8px' }}>
                Indent color for when there is a mix between spaces and tabs in
                the indentation. Can be any type of web based color format (hex,
                rgba, rgb) or a empty string(to be disabled this coloring).
              </div>
              <div
                className="col"
                style={{
